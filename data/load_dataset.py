...
_URLs = {
    # Train sub-datasets
    "train+SQuAD": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/train/SQuAD.jsonl.gz",
    "train+NewsQA": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/train/NewsQA.jsonl.gz",
    "train+TriviaQA": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/train/TriviaQA.jsonl.gz",
    "train+SearchQA": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/train/SearchQA.jsonl.gz",
    "train+HotpotQA": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/train/HotpotQA.jsonl.gz",
    "train+NaturalQuestions": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/train/NaturalQuestions.jsonl.gz",
    # Validation sub-datasets
    "validation+SQuAD": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/SQuAD.jsonl.gz",
    "validation+NewsQA": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/NewsQA.jsonl.gz",
    "validation+TriviaQA": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/TriviaQA.jsonl.gz",
    "validation+SearchQA": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/SearchQA.jsonl.gz",
    "validation+HotpotQA": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/HotpotQA.jsonl.gz",
    "validation+NaturalQuestions": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/NaturalQuestions.jsonl.gz",
    # Test sub-datasets
    "test+BioASQ": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/BioASQ.jsonl.gz",  # BioASQ.jsonl.gz
    "test+DROP": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/DROP.jsonl.gz",
    "test+DuoRC": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/DuoRC.jsonl.gz",
    "test+RACE": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/RACE.jsonl.gz",
    "test+RelationExtraction": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/RelationExtraction.jsonl.gz",
    "test+TextbookQA": "/home/kaixuanj/p_tuning/SeqLabel/MRQA/data/dev/TextbookQA.jsonl.gz",
}
            ...
            with open(filepath, encoding="utf-8") as f:
                ...
                for row in f:
                    ...
                    for qa in paragraph["qas"]:
                        ...
                        answers = qa["answers"]
                        answer_starts = [s['char_spans'][0]['start'] for s in detected_answers]
                        yield qid, {
                            # "title": title,
                            "context": context,
                            "question": question,
